  ...
  render() {
    ...
    return (
      <div className="filter-by-date">
        <p className="filter-by-date-message filter-by-date-alert">Attention: Data for May 2026 and later are known to be incomplete. NYC OpenData is working on it.</p>
